...
const MobileMenu = () => { 
 ...
 const [pages, setPages] = useState (false);
  ...
  return (
         <div className="mobile" style={{display: showNav ? 'initial' : 'none'}} > 
        <div className="delete" onClick={() => setShowNav(false)}>
            X
        </div>
    ...
    >
      ...
      />
        ...
        <nav className="dropdownList" style={{display: showDrop ? 'initial' : 'none'}}>
            <ul>
      ...
      height="1em"
      width="1em"
      onClick={() => setPages((pages) => !pages)}
      style= {{transform: pages ? [{ rotate: '90deg' }] : 'none'}}
    >
      <Path d="M5.536 21.886a1.004 1.004 0 001.033-.064l13-9a1 1 0 000-1.644l-13-9A.998.998 0 005 3v18a1 1 0 00.536.886zM7 4.909L17.243 12 7 19.091V4.909z" />
                     ...
                     <ul className="dropdown-content" style={{display: pages ? 'initial' : 'none'}}>
